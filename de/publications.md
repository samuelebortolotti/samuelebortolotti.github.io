...
description: Meine neuesten Artikel und Preprints, synchronisiert mit DBLP.
---
# Veröffentlichungen

{% if site.data.publications %}
<p class="synced">
  Synchronisiert von <a href="{{ site.data.publications.source }}.html">{{ site.data.publications.source_name }}</a>
  am {{ site.data.publications.last_updated | date: "%-d.%m.%Y" }}
  &middot; {{ site.data.publications.count }} Einträge.
</p>
{% endif %}
